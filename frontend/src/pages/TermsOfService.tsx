    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 md:py-24 max-w-5xl">
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/90 leading-relaxed">
            You may terminate your account at any time by contacting us via the official website contact form. However, termination does not entitle you to any refund of fees previously paid.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            These Terms of Service shall be governed by and construed in accordance with the laws of India, without regard to its conflict of law provisions. Any disputes arising from these Terms or your use of our platform shall be subject to the exclusive jurisdiction of the courts located in India.
          </p>
          <p className="text-foreground/90 leading-relaxed">
