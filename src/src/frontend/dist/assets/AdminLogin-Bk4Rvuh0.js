import { u as useNavigate, r as reactExports, j as jsxRuntimeExports, f as Shield, U as User, L as Lock, g as LoaderCircle } from "./index-Yh7n2f4_.js";
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `admin-login-card admin-glow-card relative w-full max-w-md mx-4 rounded-2xl p-8 ${shake ? "admin-shake" : ""}`,
              style: {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-8", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "rgba(255,255,255,0.5)" }, children: "Evergreen Hub — Secure Access" })
                ] }),
