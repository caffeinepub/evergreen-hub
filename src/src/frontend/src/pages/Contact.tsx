              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-emerald-950/20 to-emerald-900/10 border border-emerald-500/20 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    Join thousands of successful affiliate marketers who have
                    transformed their lives with our courses.
                  </p>
                  <Button
                    onClick={() =>
              ...
              <div className="bg-card border border-border rounded-2xl p-8 soft-shadow">
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Form bharo — seedha hamare WhatsApp pe aa jayega (new tab
                    mein khulega, page redirect nahi hoga)
                  </p>
                </div>
                <ContactInterestForm />
              </div>
