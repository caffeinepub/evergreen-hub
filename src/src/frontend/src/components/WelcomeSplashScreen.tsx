...
export default function WelcomeSplashScreen() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #0a2e1a 0%, #0d3b22 30%, #0a1628 70%, #060e1a 100%)",
    ...
    >
        ...
        {Array.from({ length: 18 }, (_, i) => i).map((i) => (
          <div
            ...
            style={{
              ...
              background:
                i % 3 === 0 ? "#34d399" : i % 3 === 1 ? "#f97316" : "#60a5fa",
      ...
      >
        ...
        {/* Sparkle stars */}
        <div
          className="absolute top-8 left-8 text-yellow-300 text-xl animate-bounce"
          style={{ animationDelay: "0.2s" }}
        >
          ✦
        </div>
        <div
          className="absolute top-12 right-12 text-emerald-300 text-sm animate-bounce"
          style={{ animationDelay: "0.8s" }}
        >
          ✦
        </div>
        <div
          className="absolute bottom-20 left-16 text-orange-300 text-xs animate-bounce"
        ...
        <h1
          ...
          style={{
            background:
              "linear-gradient(135deg, #34d399 0%, #f97316 50%, #60a5fa 100%)",
