      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold mb-3">
            Professional Website <span className="text-orange-400">Banwao</span>
          </h2>
          <p className="text-blue-200 max-w-xl mx-auto">
            Apne business ko online lao. Beautiful, fast, aur SEO-friendly
            websites jo real leads laayein.
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {otherPackages.map((pkg, i) => (
              <div
                ...
                onClick={() => navigate({ to: "/web-design-services" })}
                onKeyDown={(e) =>
                  e.key === "Enter" && navigate({ to: "/web-design-services" })
                }
              >
                <p className="font-bold text-white text-sm mb-1">{pkg.name}</p>
                <p
                  className={`text-2xl font-extrabold ${i === 1 ? "text-orange-400" : "text-blue-200"}`}
                >
                  {pkg.price}
                </p>
