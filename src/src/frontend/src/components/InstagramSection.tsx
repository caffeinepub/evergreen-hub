...
const INSTAGRAM_URL =
  "https://www.instagram.com/evergreenhub2026?igsh=bm1icXo1bWxrNTMw";
      ...
      >
        ...
        >
          ...
          <p className="text-white/70 text-sm mb-6">
            Get daily motivation, tips, and behind-the-scenes content. Follow us
            for your daily dose of digital inspiration!
          </p>
