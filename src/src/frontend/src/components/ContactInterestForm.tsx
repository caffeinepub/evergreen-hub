    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 text-center space-y-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          Your inquiry has been saved. WhatsApp has been opened for you to send
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-gray-400 text-center">
        WhatsApp will open in a new tab. Your inquiry is also saved to our
        system.
      </p>
    </form>
  );
