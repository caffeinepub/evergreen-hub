...
export function useUpdateLandingPage() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      title,
      content,
    }: { pageId: bigint; title: string; content: string }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useCreatePackage() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      price,
      courses,
    }: { name: string; price: bigint; courses: string }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useUpdatePackage() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      price,
      courses,
    }: { packageId: bigint; name: string; price: bigint; courses: string }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useGetPaymentProofsByStatus(
...
export function useUpdateRequestStatus() {
  ...
  return useMutation({
    mutationFn: async ({
      requestId,
      status,
    }: { requestId: bigint; status: WithdrawalRequestStatus }) => {
      if (!actor) throw new Error("Actor not available");
