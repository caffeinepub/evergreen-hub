...
export default function PrivacyPolicy() {
  ...
  useEffect(() => {
    document.title =
      "Privacy Policy - Evergreen Hub | Data Protection & User Rights";
      ...
      <main className="container mx-auto px-4 py-16 md:py-24 max-w-5xl">
        ...
        >
          ...
          <p className="text-foreground leading-relaxed mb-4">
            Welcome to Evergreen Hub. We are committed to protecting your
            privacy and ensuring the security of your personal information. This
            Privacy Policy explains how we collect, use, store, and protect your
            data when you use our online educational platform for digital
            courses and affiliate marketing training.
          </p>
          <p className="text-foreground leading-relaxed">
            By accessing or using Evergreen Hub, you agree to the terms outlined
            in this Privacy Policy. If you do not agree with these terms, please
        ...
        >
          ...
          <p className="text-foreground leading-relaxed mb-4">
            When you register or interact with our platform, we may collect the
          ...
          <p className="text-foreground leading-relaxed mb-6">
            ...
            payment providers. We do not store your complete credit card or
            debit card information on our servers. Payment processors may
            collect billing information, transaction details, and payment method
            information necessary to complete your purchase.
          </p>
          ...
          <p className="text-foreground leading-relaxed mb-4">
            ...
            how you interact with our platform, including:
          </p>
        ...
        >
          ...
          <p className="text-foreground leading-relaxed font-semibold">
            Important: We do not sell, rent, or trade your personal information
        ...
        >
          ...
          <p className="text-foreground leading-relaxed mb-4">
            Evergreen Hub uses cookies and similar tracking technologies to
            enhance your experience on our platform. Cookies are small text
            files stored on your device that help us recognize you, remember
            your preferences, and analyze site traffic.
          </p>
          <p className="text-foreground leading-relaxed mb-4">
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground leading-relaxed">
            To exercise these rights, please contact us via WhatsApp at
            ********60 or through our contact page.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground leading-relaxed">
            ...
            with a new "Last Updated" date. Your continued use of our platform
