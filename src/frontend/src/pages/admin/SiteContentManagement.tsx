...
import { ExternalBlob, type SiteContent } from "../../backend";
import {
  useGetPersistentSiteContent,
  useSetPersistentSiteContent,
    ...
    <div className="p-6 space-y-6 max-w-3xl">
      ...
      <Card className="border-gray-200 dark:border-gray-700">
        <CardHeader>
          ...
          <CardDescription>
            Phone number used for WhatsApp button and contact forms
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Include country code without + (e.g. 919263989760 for India)
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-gray-200 dark:border-gray-700">
        <CardHeader>
          ...
          <CardDescription>
            Shown in the payment gateway for UPI transfers
          </CardDescription>
        </CardHeader>
      ...
      <Card className="border-gray-200 dark:border-gray-700">
        <CardHeader>
          ...
          <CardDescription>
            Shown for manual bank transfer payments
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
