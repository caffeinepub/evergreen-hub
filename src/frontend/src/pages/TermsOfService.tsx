      ...
      <main className="container mx-auto px-4 py-16 md:py-24 max-w-5xl">
        ...
        >
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            Welcome to Evergreen Hub. By accessing, browsing, or using our
            online educational platform, you acknowledge that you have read,
            understood, and agree to be bound by these Terms of Service and all
            applicable laws and regulations.
          </p>
          <p className="text-foreground/90 leading-relaxed mb-4">
            These Terms constitute a legally binding agreement between you and
            Evergreen Hub. If you do not agree with any part of these Terms, you
            must immediately discontinue use of our platform and services.
          </p>
        ...
        >
          ...
          <p className="text-foreground/90 leading-relaxed">
            ...
            eligibility requirements. We reserve the right to verify your
            eligibility and refuse service to anyone at our sole discretion.
          </p>
        </section>
        ...
        >
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            When you create an account with Evergreen Hub, you are responsible
            for:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
            ...
            <li>
              Not sharing your account with others or allowing others to access
              your account
            </li>
          </ul>
          <p className="text-foreground/90 leading-relaxed">
            You agree not to create multiple accounts, use false identities, or
            impersonate any person or entity. We are not liable for any loss or
        ...
        >
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            Upon successful purchase of a course or package, you will receive
            lifetime access to the course materials unless otherwise stated at
          ...
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
            ...
            <li>
              Terminate your account for breach of terms or fraudulent activity
            </li>
          </ul>
          <p className="text-foreground/90 leading-relaxed">
            Course access is for personal use only. You may not share,
            distribute, or resell course content without explicit written
            permission from Evergreen Hub.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            All content on Evergreen Hub, including but not limited to courses,
            videos, text, graphics, logos, images, audio clips, digital
            downloads, and software, is the exclusive property of Evergreen Hub
            or its content creators and is protected by copyright, trademark,
            and other intellectual property laws.
          </p>
          <p className="text-foreground/90 leading-relaxed mb-4">
            You are granted a limited, non-exclusive, non-transferable license
            to access and use the course materials for personal educational
            purposes only. You may not:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
            <li>
              Copy, reproduce, distribute, or publicly display course content
            </li>
            ...
            <li>
              Share login credentials or course access with unauthorized users
            </li>
          </ul>
          <p className="text-foreground/90 leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            All prices displayed on Evergreen Hub are in the specified currency
            and are subject to change without notice. By making a purchase, you
            agree to:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            ...
            providers. We do not store your complete payment card information.
            All transactions are final and subject to our Refund Policy.
          </p>
          <p className="text-foreground/90 leading-relaxed">
            In the event of payment disputes, chargebacks, or fraudulent
            transactions, we reserve the right to suspend or terminate your
            account and take appropriate legal action.
          </p>
        </section>
        ...
        <section className="mb-12 bg-amber-50 dark:bg-amber-950/20 p-6 rounded-lg border-2 border-[#F59E0B]">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4 font-semibold">
            IMPORTANT: Evergreen Hub provides educational content and training
            related to affiliate marketing, digital skills, and online business
            strategies. However, we make NO GUARANTEES regarding income,
            earnings, or financial results.
          </p>
          <p className="text-foreground/90 leading-relaxed mb-4">
            Any income claims, earnings examples, or success stories presented
            on our platform are for illustrative purposes only and do not
            represent typical results. Individual results will vary
            significantly based on numerous factors including but not limited
            to:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4 font-semibold">
            Results vary based on individual effort, experience, and market
            conditions. Success in affiliate marketing or any online business
            requires hard work, persistence, and often involves financial risk.
          </p>
          <p className="text-foreground/90 leading-relaxed">
            By purchasing our courses, you acknowledge that you understand there
            are no guaranteed outcomes and that your success depends entirely on
            your own actions and circumstances. Evergreen Hub is not responsible
            for your business decisions or financial results.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
            ...
            <li>
              Sharing, distributing, or reselling course content without
              authorization
            </li>
            <li>
              Using the platform for fraudulent, illegal, or unauthorized
              purposes
            </li>
            <li>
            ...
            <li>
              Posting spam, promotional content, or unsolicited communications
            </li>
          </ul>
          <p className="text-foreground/90 leading-relaxed">
            Violation of these prohibitions may result in immediate termination
            of your account, forfeiture of access to purchased courses, and
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, EVERGREEN HUB AND ITS
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            ...
            tort, negligence, strict liability, or otherwise) and whether or not
            we have been advised of the possibility of such damages.
          </p>
          <p className="text-foreground/90 leading-relaxed mb-4">
            Our total liability to you for any claims arising from your use of
            the platform shall not exceed the amount you paid to Evergreen Hub
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            ...
            and access to our platform at any time, with or without notice, for
          ...
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
            ...
            <li>
              Any conduct that we deem harmful to our platform or community
            </li>
          </ul>
          <p className="text-foreground/90 leading-relaxed mb-4">
            Upon termination:
          ...
          <ul className="list-disc list-inside space-y-2 mb-4 text-foreground/90">
            <li>
              Your access to all courses and materials will be immediately
              revoked
            </li>
          ...
          <p className="text-foreground/90 leading-relaxed">
            You may terminate your account at any time by contacting us via the
            official website contact form. However, termination does not entitle
            you to any refund of fees previously paid.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-foreground/90 leading-relaxed mb-4">
            ...
            our platform shall be subject to the exclusive jurisdiction of the
        ...
        <section className="mb-12 bg-secondary p-6 rounded-lg">
          ...
          <ul className="space-y-2 text-foreground/90">
            <li>
              <strong>WhatsApp:</strong> ********60
            </li>
            <li>
              <strong>Instagram:</strong> @rajput.rudra_s
            </li>
            <li>
              <strong>Platform:</strong> Evergreen Hub
            </li>
          </ul>
        </section>
      </main>
