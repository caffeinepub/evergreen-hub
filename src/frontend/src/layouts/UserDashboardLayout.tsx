      ...
      <div className="flex h-full flex-col bg-black border-r border-gray-800">
        ...
        <nav className="flex-1 space-y-1 p-4">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-green-500 hover:bg-gray-900 hover:text-yellow-400 transition-colors"
          >
