          ...
          {submitted ? (
            ...
            <div className="text-center py-6">
              ...
              <p className="text-gray-600 dark:text-slate-400 text-sm mb-6">
                ...
                send the screenshot in the WhatsApp chat for faster
                verification.
              </p>
              <button
                type="button"
            ...
            <>
              ...
              <div>
                ...
                <p className="text-center text-xs text-gray-500 dark:text-slate-400 mt-2">
                  Tap to open in UPI app, or scan with PhonePe, Google Pay,
                  Paytm
                </p>
              </div>
              ...
              <p className="text-center text-xs text-gray-400 dark:text-slate-500">
                After clicking, WhatsApp will open with your payment details
                pre-filled
              </p>
            </>
          )}
