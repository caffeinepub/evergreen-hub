  ...
  return (
    <Card className="bg-white dark:bg-slate-800 border-2 border-emerald-500">
      <CardHeader>
        ...
        <CardDescription>
          Earn commissions when you refer users to purchase packages
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-4 p-3 bg-emerald-50 dark:bg-emerald-950/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
          <p className="text-sm text-emerald-800 dark:text-emerald-200">
            <strong>Active Income:</strong> Earned immediately when your
            referral purchases a package
          </p>
          <p className="text-sm text-emerald-800 dark:text-emerald-200 mt-1">
            <strong>Passive Income:</strong> Additional earnings from your
            referral network
          </p>
        </div>
      </CardContent>
