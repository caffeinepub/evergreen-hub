...
import { CheckCircle, Clock, Sparkles, Video } from "lucide-react";
...
export default function VideoEditingSection() {
  ...
  const message = encodeURIComponent(
    "Hello! I want to order video editing service.",
  );
  ...
  const features = [
    {
      ...
      description: "High-quality video editing with transitions and effects",
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description: "Professional polish for your content",
    },
  ];
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Transform your raw footage into stunning videos. Perfect for
              YouTube, Instagram, and promotional content.
            </p>
          </div>
            ...
            <Card className="border-2 border-primary/20 shadow-xl">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-lg">
                  Professional editing at an affordable price
                </CardDescription>
                <div className="mt-4">
              ...
              <CardContent className="space-y-6">
                ...
                <p className="text-center text-sm text-muted-foreground">
                  💡 Tip: Send us your raw footage via WhatsApp or Google Drive
                  link after payment
                </p>
              </CardContent>
            </Card>
