import { Award, Globe, MapPin, Star, TrendingUp, Video } from "lucide-react";
...
export default function FounderSection({
  ...
  return (
    <section
      className={`relative overflow-hidden ${compact ? "py-12" : "py-20"} px-4`}
    >
      {/* Background */}
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-2/5 bg-gradient-to-br from-emerald-900/60 to-gray-900/60 p-8 flex flex-col items-center justify-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-400 text-sm mt-1">
                    Digital Entrepreneur & Web Designer
                  </p>
                </div>
              ...
              <div className="lg:w-3/5 p-8 md:p-10 flex flex-col justify-center">
                ...
                <div className="text-emerald-500/20 text-8xl font-serif leading-none mb-2 select-none">
                  "
                </div>
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed -mt-6">
                  ...
                  <p>
                    I help coaching institutes, affiliate marketers, bloggers,
                    and local businesses grow online with professional websites,
                    Google Map profiles, and lead-focused digital solutions.
                  </p>

                  <p>
                    As a passionate digital entrepreneur and affiliate marketer,
                    I also provide{" "}
                    ...
                    to help businesses promote their brand and products
                    effectively online.
                  </p>

                  <p>
                    At Evergreen Hub, my mission is to combine modern design,
                    smart functionality, and high-quality content to deliver
                    solutions that not only look professional but also{" "}
                    <span className="text-yellow-400 font-medium">
                      drive real results
                    </span>
                    . Whether you're starting your first website, boosting your
                    online presence, or creating engaging marketing videos, I
                    make sure your business stands out in the digital world.
                  </p>
                </div>
